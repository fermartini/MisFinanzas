            ...
            <div className='flex flex-col xl:grid xl:grid-cols-2  gap-10 my-10'>
                <div>
                    ...
                    {loading || authloading ? <div><Loading /></div>  : (gastosConNombre.map((gasto) => (
                        <ListaGastos icono={gasto.icono} key={gasto.id} importe={gasto.importe}  gastoId={gasto.id} gastoNombre={gasto.nombreGasto} gast={gastoFiltrado} />
                    ))
                    )}
                </div>
                <div>
                    ...
                    {loading || authloading ? <div><Loading /></div>  : (ingresosConNombre.map((ingreso) => (
                        <ListaGastos icono={ingreso.icono} key={ingreso.id} importe={ingreso.importe} ingresoId={ingreso.id} gastoNombre={ ingreso.nombreIngreso} ingres={ingresoFiltrado} />
                    ))
                    )}
                </div>
            </div>
