...
export default function Sesion() {
  ...
  if (!user)
    return (
      <>
        <Link to="/" className='bg-gray-700 text-white text-2xl h-20 lg:w-32 w-screen my-10  absolute bottom-0 lg:top-0 lg:m-10 hover:text-red-500  rounded-xl justify-center items-center flex p-1 shadow-sm shadow-white  active:translate-y-1 transition-all duration-75'>
        <FlechaVolver style='w-10 '/>
        </Link>
