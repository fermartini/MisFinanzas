...
const Toggle = ({checked, onChange}) => {
    ...
    return (
        <label className=" items-center cursor-pointer grid grid-cols-3 mt-5 justify-between ">
            <span className="ms-3 mx-2 col-span-1  font-medium text-gray-900 dark:text-gray-300" style={{ fontSize: !checked ? '2rem' : '1rem'}}>
                Gastos
            </span>
            <input
                type="checkbox"
            ...
            />
            <span className=" col-span-1   font-medium text-gray-900 dark:text-gray-300" style={{ fontSize: checked ? '2rem' : '1rem' }}>
                Ingresos
            </span>
        </label>
    );
